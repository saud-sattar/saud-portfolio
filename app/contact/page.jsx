            ...
            <div className="container mx-auto">
               <div className="flex flex-col xl:flex-row gap-[30px]">
                  ...
                  <div className="xl:w-[54%] order-2 xl:order-none">
                     <form className="flex flex-col gap-6 p-10 bg-[#084c61]/30 rounded-xl">
                        <h3 className="text-4xl text-[#eddea4]">Lets work together</h3>
                        <p className="text-[#f9f7f3]/60">yippe yappee</p>
                        {/* input */}
                        ...
                        {info.map((item, index) => {
                           return <li key={index} className="flex items-center gap-6">
                              ...
                              <div className="flex-1">
                                 <p className="text-[#f9f7f3]/60">{item.title}</p>
